...
class BridgeTransport extends abstract_1.AbstractTransport {
    ...
    call({ session, name, data, protocol }) {
        return this.scheduleAction((signal) => tslib_1.__awaiter(this, void 0, void 0, function* () {
            const { encode, decode } = protocol || protocol_1.bridge;
            const [bytes] = (0, send_1.buildBuffers)(this.messages, name, data, encode);
            ...
            const message = yield (0, receive_1.receiveAndParse)(this.messages, () => Promise.resolve(Buffer.from(response.payload, 'hex')), decode);
    ...
    receive({ session, protocol }) {
        return this.scheduleAction((signal) => tslib_1.__awaiter(this, void 0, void 0, function* () {
            ...
            const { decode } = protocol || protocol_1.bridge;
            const message = yield (0, receive_1.receiveAndParse)(this.messages, () => Promise.resolve(Buffer.from(response.payload, 'hex')), decode);
            return this.success(message);
        }));
    }
    ...
    _post(endpoint, options) {
        return tslib_1.__awaiter(this, void 0, void 0, function* () {
            const { timeout, signal } = options, restOptions = tslib_1.__rest(options, ["timeout", "signal"]);
