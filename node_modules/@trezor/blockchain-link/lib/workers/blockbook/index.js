...
const getBlockHash = (request) => tslib_1.__awaiter(void 0, void 0, void 0, function* () {
    const api = yield request.connect();
    const info = yield api.getBlockHash(request.payload);
    return {
        type: constants_1.RESPONSES.GET_BLOCK_HASH,
        payload: info.hash,
    };
});
const getBlock = (request) => tslib_1.__awaiter(void 0, void 0, void 0, function* () {
    const api = yield request.connect();
    const info = yield api.getBlock(request.payload);
    return {
...
const getAccountInfo = (request) => tslib_1.__awaiter(void 0, void 0, void 0, function* () {
    ...
    const api = yield request.connect();
    const info = yield api.getAccountInfo(payload);
    return {
...
const getAccountUtxo = (request) => tslib_1.__awaiter(void 0, void 0, void 0, function* () {
    const { payload } = request;
    const api = yield request.connect();
    const utxos = yield api.getAccountUtxo(payload);
    return {
...
const getAccountBalanceHistory = (request) => tslib_1.__awaiter(void 0, void 0, void 0, function* () {
    const { payload } = request;
    const api = yield request.connect();
    const history = yield api.getAccountBalanceHistory(payload);
    return {
        type: constants_1.RESPONSES.GET_ACCOUNT_BALANCE_HISTORY,
        payload: history,
    };
});
const getCurrentFiatRates = (request) => tslib_1.__awaiter(void 0, void 0, void 0, function* () {
    const { payload } = request;
    const api = yield request.connect();
    const fiatRates = yield api.getCurrentFiatRates(payload);
    return {
        type: constants_1.RESPONSES.GET_CURRENT_FIAT_RATES,
        payload: fiatRates,
    };
});
const getFiatRatesForTimestamps = (request) => tslib_1.__awaiter(void 0, void 0, void 0, function* () {
    const { payload } = request;
    const api = yield request.connect();
    const { tickers } = yield api.getFiatRatesForTimestamps(payload);
    return {
        type: constants_1.RESPONSES.GET_FIAT_RATES_FOR_TIMESTAMPS,
        payload: { tickers },
    };
});
const getFiatRatesTickersList = (request) => tslib_1.__awaiter(void 0, void 0, void 0, function* () {
    const { payload } = request;
    const api = yield request.connect();
    const tickers = yield api.getFiatRatesTickersList(payload);
    return {
...
const getTransaction = (request) => tslib_1.__awaiter(void 0, void 0, void 0, function* () {
    const api = yield request.connect();
    const tx = yield api.getTransaction(request.payload);
    return {
...
const pushTransaction = (request) => tslib_1.__awaiter(void 0, void 0, void 0, function* () {
    const api = yield request.connect();
    const resp = yield api.pushTransaction(request.payload);
    return {
...
const subscribeFiatRates = (ctx, currency) => tslib_1.__awaiter(void 0, void 0, void 0, function* () {
    const api = yield ctx.connect();
...
const subscribeMempool = (ctx) => tslib_1.__awaiter(void 0, void 0, void 0, function* () {
    const api = yield ctx.connect();
...
const subscribe = (request) => tslib_1.__awaiter(void 0, void 0, void 0, function* () {
    ...
    if (payload.type === 'accounts') {
        ...
        response = yield subscribeFiatRates(request, payload.currency);
    }
    else if (payload.type === 'mempool') {
        response = yield subscribeMempool(request);
    }
    else {
...
const unsubscribeFiatRates = ({ state, connect }) => tslib_1.__awaiter(void 0, void 0, void 0, function* () {
...
const unsubscribeMempool = ({ state, connect }) => tslib_1.__awaiter(void 0, void 0, void 0, function* () {
...
const unsubscribe = (request) => tslib_1.__awaiter(void 0, void 0, void 0, function* () {
    ...
    if (payload.type === 'accounts') {
        ...
        response = yield unsubscribeFiatRates(request);
    }
    else if (payload.type === 'mempool') {
        response = yield unsubscribeMempool(request);
    }
    else {
        throw new errors_1.CustomError('invalid_param', '+type');
    }
