...
const getAccountInfo = (request) => tslib_1.__awaiter(void 0, void 0, void 0, function* () {
    ...
    const getTransactionPage = (txIds) => tslib_1.__awaiter(void 0, void 0, void 0, function* () {
        const transactionsPage = yield fetchTransactionPage(api, txIds);
        return (yield Promise.all(transactionsPage
            .filter(isValidTransaction)
            .map(tx => blockchain_link_utils_1.solanaUtils.transformTransaction(tx, payload.descriptor)))).filter((tx) => !!tx);
    });
    ...
    const transactionPage = details === 'txs' ? yield getTransactionPage(txIdPage) : undefined;
    let tokens = [];
...
const subscribeAccounts = ({ connect, state, post }, accounts) => tslib_1.__awaiter(void 0, void 0, void 0, function* () {
    ...
    const newAccounts = accounts.filter(account => !subscribedAccounts.some(subscribeAccount => account.descriptor === subscribeAccount.descriptor));
