    ...
    function Wallet(provider, network) {
        ...
        _this.signAndSendTransaction = function (transaction, options) {
            ...
            return __awaiter(_this, void 0, void 0, function () {
                ...
                return __generator(this, function (_a) {
                    switch (_a.label) {
                        case 0: return [4 /*yield*/, this._sendRequest('signAndSendTransaction', __assign({ transaction: bs58.encode(transaction.serialize({ requireAllSignatures: false, verifySignatures: false })) }, options))];
                        case 1:
                            response = _a.sent();
                            publicKey = response.publicKey, signature = response.signature;
                            return [2 /*return*/, { publicKey: new PublicKey(publicKey), signature: signature }];
                    }
                });
            });
        };
